...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   return (
    <div className="min-h-screen bg-gradient-to-r from-amber-400 to-amber-800 flex items-center justify-center p-4">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-amber-800 text-black py-3 rounded-lg hover:bg-amber-400 transition duration-300 font-medium shadow-md  text-black placeholder-gray-400"
            >
